			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"YMM01_App-display": {
								"semanticObject": "YMM01_App",
								"action": "display",
								"description": "The Fiori App for the SAP GUI YMM01 Transaction",
								"title": "YMM01_App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ehb.YMM01_App",
									"url": sap.ui.require.toUrl("ehb/YMM01_App")
								}
							}
						}
					}
